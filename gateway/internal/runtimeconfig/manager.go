...
func NewManager(key string, watcher KVWatcher, store *Store, logger *zap.Logger) (*Manager, error) {
	...
	return &Manager{key: key, watcher: watcher, store: store, logger: logger}, nil
}
