...
//
// AuthService provides identity and session validation for trusted internal callers.
// The Admin process may implement this service initially; it can later be moved to
// an independent authentication service without changing Gateway's RPC contract.
type AuthServiceClient interface {
	// ValidateSession verifies that a JWT identity still has an active server-side
	// session. Gateway calls this method after validating the JWT signature and expiry.
